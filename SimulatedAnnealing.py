...
def simulated_annealing(sol):
    ...
    while temp > temp_min:
        i = 1
        while i <= 100:
            new_sol = get_rand_neighbor(sol)
            new_cost = evaluate_sol(new_sol)
...
def get_rand_neighbor(sol):
    pass


def evaluate_sol(new_sol):
    pass
